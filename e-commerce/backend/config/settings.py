...
# CORS settings - Allow Next.js frontend to access the API
...
# MongoDB Settings (optional - can use SQLite for development)
MONGODB_HOST = config('MONGODB_HOST', default='localhost')
MONGODB_PORT = config('MONGODB_PORT', default=27017)
MONGODB_NAME = config('MONGODB_NAME', default='ecommerce')
